...
londres = Tour.create!(name: "Wimbledon", city: "Londres", country: "Angleterre", capacity: 8, date: Date.new(2020, 8, 2), duration: 90, language: "Français", user: edouard, price: 15, category: "sport", time: Time.new(2020, 8, 2, 0, 0), live_url: "https://travelive.daily.co/A10gZsu1NrLQxfd2wfgf", description: "La visite du Wimbledon Lawn Tennis Museum and Tour qui nous entraîne dans les coulisses du stade, sur le Court Central, le court n°1, dans la salle de conférences  et au musée du tennis est un passage incontournable pour tous sportifs  fans de tennis.")
recife = Tour.create!(name: "Le brésil autrement", city: "Recife", country: "Bresil", capacity: 10, date: Date.new(2020, 10, 10), duration: 90, language: "Français", user: edouard, price: 10, category: "insolite", time: Time.new(2020, 10, 10, 13, 0, 0), live_url: "https://travelive.daily.co/A10gZsu1NrLQxfd2wfgf", description: "Recife est une destination touristique très importante du Brésil. Son architecture coloniale et ses plages paradisiaques attirent des milliers de visiteurs chaque année. Les touristes apprécient particulièrement l'eau turquoise qui borde la ville sur 40 km. Pour les visiteurs en quête de découverte, Recife possède une vieille ville fascinante. Ne manquez pas le fort de São Tiago das Cinco Pontas et les très nombreux édifices religieux, cathédrales, couvents, chapelles...")
...
húsavík = Tour.create!(name: "La découverte des Baleines", city: "Húsavík", country: "Islande", capacity: 12, date: Date.new(2021, 2, 10), duration: 120, language: "Français", user: edouard, price: 35, category: "Animaux", time: Time.new(2021, 2, 10, 12, 0, 0), live_url: "https://travelive.daily.co/A10gZsu1NrLQxfd2wfgf", description: "Prenez part à une sortie d’observation des baleines dans leur habitat naturel depuis Húsavík. Montez à bord d’un bateau en bois traditionnel islandais pour une aventure guidée de 3 h. Profitez de 97/100 à 99/100 de chances de voir des baleines !")
...
huairou = Tour.create!(name: "La Muraille de Chine", city: "Huairou", country: "Chine", capacity: 25, date: Date.new(2021, 2, 9), duration: 120, language: "Français", user: edouard, price: 22, category: "Culture", time: Time.new(2021, 2, 9, 10, 0, 0), live_url: "https://travelive.daily.co/A10gZsu1NrLQxfd2wfgf", description: "La Grande Muraille de Chine est un passage quasi obligé pour quiconque vient visiter le pays. Sur 6 700 km, elle ondule à perte de vue. Vous pouvez visiter la Grande Muraille de Chine sur plusieurs tronçons : Badaling, site le plus touristique, Mutianyu, plus sauvage, ou Simatai, plus authentique. Vous pouvez aussi effectuer des randonnées le long de la Grande Muraille de Chine entre Simatai et Janshanling.")
...
photo = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593591556/lksqP9SA_gip2fu.jpg")
...
photo7_romain = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593527986/jwox0lccdjoof28ridxk15k65gvd.jpg")
photo8_romain = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593527983/h4h2z9x63lq8mriz92dnd6e51ac9.jpg")
photo9_romain = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593527980/o4wshq0zn6ox8nmfuo2xzlsylsz0.jpg")
...
photo10_romain = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593527983/whdzjripkepyoyfweo5998gdb73r.jpg")
photo11_romain = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593416615/xhxpug5dw5to1uua072q0geuo48g.jpg")
...
fabiola1 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593081255/r1idgpc4asnj30fuy1j7zuqxs4c8.jpg")
fabiola2 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593163639/ben-vloon-MSkaRatXB3I-unsplash_et4oiu.jpg")
fabiola3 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593163694/julian-berengar-solter-twzfUdCDahs-unsplash_vrlmo4.jpg")
...
fabiola4 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593527135/jonathan-farber-3kJAGpZWR7E-unsplash_gudu4j.jpg")
fabiola5 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593527211/howard-bouchevereau-vHnQqO3TT4c-unsplash_ktmldv.jpg")
fabiola6 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593527253/kurt-cotoaga-fkCcgQkqRaA-unsplash_hwsw14.jpg")
...
photo12_edouard = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593528053/w00ks4fduyiurh582mohs2m4bd58.jpg")
...
edouard1 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593083310/thiago-japyassu-56p0SF7UqcI-unsplash_vataze.jpg")
edouard2 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593164854/anderson-w-rangel-R5ZhGy-A8e4-unsplash_yhvavw.jpg")
edouard3 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593164869/thiago-japyassu-pZetlN0dtoM-unsplash_rvihyy.jpg")
recife.images.attach(io: edouard1,  filename: 'photo.jpeg', content_type: 'image/jpeg')
recife.images.attach(io: edouard2, filename: 'photo.jpeg', content_type: 'image/jpeg')
recife.images.attach(io: edouard3, filename: 'photo.jpeg', content_type: 'image/jpeg')
recife.save!

edouard4 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593096197/andrea-leopardi-z0A_IsZYXfM-unsplash_yo7kzo.jpg")
edouard5 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593164636/sasha-stories-VynkVKneWJA-unsplash_lp1pox.jpg")
edouard6 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593164624/fermin-rodriguez-penelas-r3muakP0QuE-unsplash_p4l5pv.jpg")
...
edouard7 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593096547/vaun0815-13d6w4dztcM-unsplash_ccy1yw.jpg")
edouard8= URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593164298/arvin-wiyono-einIuvtZen4-unsplash_rio6ws.jpg")
edouard9 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593164353/michael-lee-YhGQiKeSBLQ-unsplash_xh7kmu.jpg")
...
edouard10 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593098810/felipe-simo-NvSYy0EEVfc-unsplash_pmmwdj.jpg")
edouard11 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593164476/michael-parulava-L4jrg4c7928-unsplash_zwy3xr.jpg")
edouard12= URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593164448/michael-parulava-5V36D5JYcZA-unsplash_ccxct2.jpg")
...
edouard13 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593099024/violette-filippini-VO8FNHLy8SI-unsplash_ubxqzd.jpg")
edouard14 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593164089/courtney-hall-6_JmApzvvMg-unsplash_jldh6o.jpg")
edouard15= URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593164078/ashley-ross-AyUH7XHZUBQ-unsplash_rawenn.jpg")
huairou.images.attach(io: edouard13, filename: 'photo.jpeg', content_type: 'image/jpeg')
huairou.images.attach(io: edouard14, filename: 'photo.jpeg', content_type: 'image/jpeg')
huairou.images.attach(io: edouard15, filename: 'photo.jpeg', content_type: 'image/jpeg')
huairou.save!

edouard16 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593099557/erwan-hesry-uJ-OO3aZsSQ-unsplash_ppoivf.jpg")
edouard17 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593163858/siamak-YpIxNnG1vC4-unsplash_nhraqx.jpg")
edouard18 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593163851/moises-alex-WqI-PbYugn4-unsplash_e7wibz.jpg")
...
fabiola7 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593600065/village-herbe-balade-printemps-42-1024x683-740x480_vyfbt4.jpg")
fabiola8 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593600136/P1170649_xcpp5b.jpg")
fabiola9 = URI.open("https://res.cloudinary.com/dzghetxbv/image/upload/v1593600123/80fcb224b98e4b90f339ace0d20f6575_tksxvi.jpg")
