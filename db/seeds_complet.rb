...
# argentine = Tour.create!(name: "Buenos Aires - La reine de la Plata", city: "Buenos Aires", country: "Argentine", capacity: 8, date: Date.new(2021, 3, 1), duration: 120, language: "English/Spanish", user: fabiola, price: 35, category: "culture",  time: Time.now, live_url: "https://travelive.daily.co/A10gZsu1NrLQxfd2wfgf", description: "Laissez-vous entrainer par le dynamisme de la capitale argentine, cité portée par une culture mêlant avec bonheur les influences européennes et africaines. Ce voyage à Buenos Aires est l’occasion de remonter aux origines du tango, tout en profitant d’une gastronomie réputée d’Amérique du Sud. De l’architecture coloniale du quartier historique de San Telmo au style plus moderne de la Place de Mai, découvrez une ambiance rythmée et joyeuse pour des souvenirs mémorables")
